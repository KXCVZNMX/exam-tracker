...
>
	...
	<div
		class="grid grid-cols-1 rounded-box border border-base-content/10 bg-base-100 shadow-sm lg:min-h-0 lg:flex-1 lg:grid-cols-[minmax(14rem,0.85fr)_minmax(20rem,1.35fr)_minmax(20rem,1.5fr)] lg:overflow-hidden"
	>
